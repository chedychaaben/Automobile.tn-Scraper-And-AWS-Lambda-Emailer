...
# Settings
smtp_email = "chedychaaben@gmail.com" # Use your email
smtp_password = "" # Put you password here
# Settings
...
def lambda_handler(event, context):
    r = requests.get('https://www.automobile.tn/fr/guide/dernieres-immatriculations.html')
    ...
    sender_email = receiver_email = smtp_email
...
lambda_handler(None,None) # Remove in production (if you will be depolying in Lambda)